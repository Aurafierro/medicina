...
public class ingreso {
	...
	public ingreso(String id_ingreso, String habitacion, int cama, String paciente, String medico, String fecha_salida,
			String estado, String telefono, String correo, String direccion, String nombre_persona_contacto,
			String telefono_persona_contacto) {
		super();
